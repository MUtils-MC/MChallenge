...
class TimerAPI: TimerAPIImplementation() {
    ...
    private fun getPersonalTimer(uuid: UUID): Timer {
        return TimerManager.getPersonalTimer(uuid) ?: TimerManager.addPersonalTimer(uuid, FabricTimer(true, uuid, TimerPresets.CLASSIC.uuid, playerList = server.playerList))
    }
}