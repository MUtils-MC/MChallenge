...
abstract class CustomInventory(
    size: Int,
    title: Component,
    private val clickEvent: ((InventoryClickEvent) -> Unit)?,
    private val closeEvent: ((InventoryCloseEvent) -> Unit)?
    ) {
    ...
    abstract class Builder {
         ...
         */
        var clickAction: ((InventoryClickEvent) -> Unit)? = null
         ...
         */
        var closeAction: ((InventoryCloseEvent) -> Unit)? = null
    }
}