...
import de.miraculixx.kpaper.await.implementations.AwaitConfirm
        ...
        when (val clickedData = settingsData[settingKey]) {
            ...
            is ChallengeSectionSetting<*> -> {
                GUITypes.CHALLENGE_SETTINGS.buildInventory(
                    ...
                    ItemsChallengeSettings(clickedData.getValue(), challengeID, customChallengeID, player.language()),
