...
class LowVisionItems : ItemProvider {
            ...
            finalMaterials.forEach { material ->
                ...
                put(itemStack(getMaterial(material)) {
                    meta {
                        ...
                        lore(listOf(emptyComponent(), msgClick + cmp("${if (isSelected) "Hide" else "Show"} Block")))
                        customModel = 1
                    }
                }, isSelected)
            }
        ...
        return listOf(
            itemStack(Material.OAK_SIGN) {
                meta {
                    ...
                    lore(listOf(emptyComponent(), msgClick + cmp("Edit Filter")))
                    customModel = 10
                }
            }
        )
